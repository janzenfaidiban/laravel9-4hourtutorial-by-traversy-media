    ...
    <x-card class="max-w-lg mx-auto mt-24">
        ...
        <form action="/listings/{{$listing->id}}" method="POST" enctype="multipart/form-data">
            ...
            <div class="mb-6">
                ...
                <p class="text-red-500 text-xs mt-1">{{$message}}</p>
                @enderror
                <img src="{{$listing->logo ? asset('storage/'. $listing->logo) : asset('/images/no-image.png')}}" alt="Image" class="w-48 my-6 mb-6">
            </div>
            ...
            <div class="mb-6">
                <button
                    class="bg-laravel text-white rounded py-2 px-4 bg-gray-900 hover:bg-gray-800"
                >
                    Update Gig
                </button>
